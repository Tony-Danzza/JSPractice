...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"utlils.js":[function(require,module,exports) {
"use strict";
...
function drawFrequency(frequencyData) {
  ...
  frequencyData.forEach(function (amount) {
    ...
    var _hslToRgb = (0, _utlils.hslToRgb)(h, s, l),
      _hslToRgb2 = _slicedToArray(_hslToRgb, 3),
      r = _hslToRgb2[0],
      g = _hslToRgb2[1],
      b = _hslToRgb2[2];
    ctx.fillStyle = "rgba(".concat(r, ", ").concat(g, ", ").concat(b, ", 0.9)");
...
getAudio();
},{"./utlils":"utlils.js"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
